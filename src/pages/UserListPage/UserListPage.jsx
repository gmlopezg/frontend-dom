...
function UserListPage() {
  ...
  const fetchUsers = async (showDefaultMessage = true) => {
    ...
    try {
      ...
      const response = await axios.get('https://backend-denuncias.onrender.com/api/usuarios', {
        headers: {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      const response = await axios.delete(`https://backend-denuncias.onrender.com/api/usuarios/${userToDeleteId}`, {
        headers: {
